    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-4 py-3">
          {/* Layout móvil: Logo arriba, botones abajo */}
          <div className="md:hidden">
            ...
            {/* Botones en fila debajo del logo */}
            <div className="flex items-center justify-between">
              {/* Botones sociales */}
          ...
          {/* Layout desktop: Logo centrado con botones a los lados */}
          <div className="hidden md:block">
            <div className="flex items-center justify-between min-h-[80px]">
              {/* Botones sociales - Izquierda */}
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="lg"
          ...
          <div className="flex justify-center pt-3 border-t border-border/20">
